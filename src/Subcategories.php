      ...
      <main id="main-container">
        ...
        <div class="content content-boxed">
          <div class="row">
            <!-- Story -->
            <?php
              $imgs = $mysql -> query("SELECT * FROM `subcategories` WHERE `lang`='arm'");

              foreach($imgs as $value){
                echo '<div class="col-lg-4"  style="text-align: center;">
                  <a class="block block-rounded block-link-pop overflow-hidden" href="assets/media/photos/'.$value['img'].'">
