    ...
    <div id="page-container" class="sidebar-o sidebar-dark enable-page-overlay side-scroll page-header-fixed main-content-narrow">
      ...
      <main id="main-container">
        ...
        <?php echo '<form action="Add-info-proccess.php?h='.$_GET['h'].'" method="post" style="padding: 15px;">' ?>
            <div class="mb-4">
                <label class="form-label" for="example-textarea-input">Գրեք տեղեկություններ</label>
                <textarea class="form-control" id="example-textarea-input" name="info" rows="10" placeholder="Մեր մասին․․․"></textarea>
            </div>
            <div class="mb-4">
                <label class="form-label">Ընտրեք լեզուն</label>
                <div class="space-y-2">
                    <div class="form-check">
                        <input class="form-check-input" type="radio" id="example-radios-default1" name="lang" value="arm" checked>
                        <label class="form-check-label" for="example-radios-default1">Հայերեն</label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="radio" id="example-radios-default2" name="lang" value="ru">
                        <label class="form-check-label" for="example-radios-default2">Ռուսերեն</label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="radio" id="example-radios-default3" name="lang" value="en">
                        <label class="form-check-label" for="example-radios-default3">Անգլերեն</label>
                    </div>
                </div>
            </div>
