    ...
    <div id="page-container" class="sidebar-o sidebar-dark enable-page-overlay side-scroll page-header-fixed main-content-narrow">
      ...
      <main id="main-container">
        ...
        <form action="" method="post" style="padding: 15px;">
            <div class="mb-4">
                <label class="form-label" for="example-text-input">Կածեգորյաի անվանումը</label>
                <input type="text" class="form-control" id="example-text-input" name="example-text-input" placeholder="Օրինակ Կղմինդր">
            </div>
            <div class="mb-4">
