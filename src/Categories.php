            ...
            <ul class="nav-main">
              ...
              <li class="nav-main-item">
                ...
                <ul class="nav-main-submenu">
                  ...
                  <li class="nav-main-item">
                    <a class="nav-main-link" href="be_pages_elearning_lesson.html">
                      <span class="nav-main-link-name">Փոփոխել կայքի տեղեկությունները</span>
                    </a>
                  </li>
                </ul>
              </li>
      ...
      <main id="main-container">
        ...
        <div class="content content-boxed">
          <div class="row">
            <!-- Story -->
            <?php
              $imgs = $mysql -> query("SELECT * FROM `assortment` WHERE `lang`='arm'");
              ...
              foreach($imgs as $value){
                echo '<div class="col-lg-4"  style="text-align: center;">
                  <div class="block block-rounded block-link-pop overflow-hidden" href="assets/media/photos/'.$value['img'].'">
                    <img class="img-fluid" src="assets/media/photos/'.$value['img'].'" alt="">
                    <h4>'.$value['type'].'</h4>
                    <a href="Delete.php?h='.$_GET['h'].'&id='.$value['id'].'&type=assortment&file=Categories.php"><button class="btn btn-danger" >Ջնջել</button></a>
                  </div>
                </div>';
              }
            ?>
